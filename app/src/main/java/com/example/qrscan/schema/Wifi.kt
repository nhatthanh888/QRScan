...
import com.example.qrscan.extension.unescape
import java.util.*
...
class Wifi(
    ...
    companion object {
        ...
        const val FORMAT_TYPE_FREE = "WIFI:T:Free"
        const val FORMAT_TYPE_WPA = "WIFI:T:WPA/WPA2"
        const val FORMAT_TYPE_WEP = "WIFI:T:WEP"
