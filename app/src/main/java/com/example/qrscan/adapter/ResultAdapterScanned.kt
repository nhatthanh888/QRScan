...
class ResultAdapterScanned(
    val context: Context,
    val onClickItem: (ResultScanModel) -> Unit,
    val listScanned: ListenerListScanned
) :
    ListAdapter<ResultScanModel, ResultAdapterScanned.ResultsViewHolder>(DiffCallbackScanned()) {

    inner class ResultsViewHolder(val binding: ItemHistoryScannedBinding) :
        ...
        fun bind(resultScanModel: ResultScanModel) {
            ...
            binding.apply {
                ...
                ckSelectedDelete.setOnCheckedChangeListener { _, isCheck ->
                    listScanned.listenUpdateItemScanned(resultScanModel.id, isCheck)
                }
            }
        }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ResultsViewHolder {
        return ResultsViewHolder(
            ItemHistoryScannedBinding.inflate(
...
class DiffCallbackScanned : DiffUtil.ItemCallback<ResultScanModel>() {
